import {EasyPostTrackerCreateResponse} from "@/easypost/TrackerCreateResponse";
...
class EasyPostTracker {
    ...
    async create(tracking_code: string, carrier: string): Promise<EasyPostTrackerCreateResponse> {
        const body = {
            tracker: {
